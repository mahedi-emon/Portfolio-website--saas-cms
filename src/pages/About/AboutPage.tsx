        ...
        <div className="grid lg:grid-cols-[300px_1fr] gap-12 items-start">
          ...
          <div className="lg:sticky lg:top-24 animate-slide-up">
            <div className="relative group card-3d">
              ...
              <div className="relative bg-[#0B1320]/80 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-white/[0.06] hover:border-white/[0.12] transition-all duration-600 ease-out card-animated">
                {about.profileImageUrl ? (
                  <div className="relative overflow-hidden rounded-2xl img-hover-shine">
                    <img 
                      className="w-full aspect-square rounded-2xl object-cover border-4 border-white/10 shadow-lg transition-transform duration-700 group-hover:scale-105" 
          ...
          <div className="space-y-16">
            ...
            <div className="animate-fade-in">
              ...
              <p className="text-lg text-[#C9D1D9] leading-relaxed max-w-3xl animate-slide-up">
              ...
              <div className="animate-fade-in" style={{ animationDelay: '500ms' }}>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {certifications.map((item, index) => (
                    <article 
                      key={item.id} 
                      className="group p-5 rounded-2xl bg-[#0B1320]/80 backdrop-blur-sm border border-white/[0.06] shadow-lg shadow-[#C77DFF]/[0.05] hover:shadow-xl hover:shadow-[#C77DFF]/[0.12] hover:border-white/[0.12] hover:-translate-y-1 transition-all duration-600 ease-out card-animated"
                      style={{ animationDelay: `${index * 100}ms` }}
                    >

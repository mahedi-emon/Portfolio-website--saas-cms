...
export function PortfolioPage() {
  ...
  useDocumentHead({
    ...
    description: 'Browse the portfolio of Mahedi Hasan Emon — featured projects, case studies, publications, achievements, and professional certifications in web development.',
    path: '/portfolio',
  });
